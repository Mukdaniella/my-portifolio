        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <p className="text-emerald-600 dark:text-emerald-400 font-semibold uppercase tracking-wider text-sm">Professional Overview</p>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-20">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 shadow-xl border border-zinc-200 dark:border-zinc-800">
                <h2 className="text-2xl font-bold mb-6 text-zinc-900 dark:text-white">Experience</h2>
                <div className="space-y-6">
                  {experience.map((exp, index) => (
                    <div key={index} className="relative pl-8 pb-8 border-l-2 border-emerald-200 dark:border-emerald-800 last:pb-0">
                      <div className="absolute -left-2 top-0 w-4 h-4 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600"></div>
                      <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-3">
                        ...
                        <span className="text-sm text-zinc-500 dark:text-zinc-500 mt-1 md:mt-0">{exp.period}</span>
                      </div>
                      <p className="text-zinc-600 dark:text-zinc-400 mb-3">{exp.description}</p>
            ...
            <div className="space-y-8">
              <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 shadow-xl border border-zinc-200 dark:border-zinc-800">
                <h2 className="text-2xl font-bold mb-6 text-zinc-900 dark:text-white">Stats</h2>
                <div className="space-y-6">
                  <div>
                    <p className="text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent mb-1">2+</p>
                    <p className="text-sm text-zinc-600 dark:text-zinc-400">Years Experience</p>
                  </div>
                  <div>
                    <p className="text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent mb-1">10+</p>
                    <p className="text-sm text-zinc-600 dark:text-zinc-400">Projects Completed</p>
                  </div>
                  <div>
                    <p className="text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent mb-1">100%</p>
                    <p className="text-sm text-zinc-600 dark:text-zinc-400">Client Satisfaction</p>
                  </div>
                </div>
              </div>

              <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 shadow-xl border border-zinc-200 dark:border-zinc-800">
                <h2 className="text-2xl font-bold mb-6 text-zinc-900 dark:text-white">Skills</h2>
                <div className="space-y-3">
                  {skills.map((skill) => (
                    <div key={skill.name} className="flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-800 rounded-xl hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-colors">
